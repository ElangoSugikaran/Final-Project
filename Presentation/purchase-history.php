...
if ($is_logged_in) {
    ...
    $query = "SELECT order_id, product_name, image, total_price, quantity, status, created_at FROM order_info WHERE email = ?";
          ...
          <?php if ($result && $result->num_rows > 0): ?>
            <?php while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <!-- <td>
                  <a href="view-order-details.php?order_id=<?php echo htmlspecialchars($row['order_id']); ?>" class="btn btn-primary">View</a>
                </td> -->
              </tr>
            <?php endwhile; ?>
          <?php else: ?>
