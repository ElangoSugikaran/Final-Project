...
<header>
  ...
  <div class="bg-primary mb-4" id="backgroundDiv">
    <div class="container py-4">
      <h3 class="text-white mt-2">Men's Eyewear</h3>
      <!-- Breadcrumb -->
      <nav class="d-flex mb-2">
        <h6 class="mb-0">
          <a href="../Presentation/home.php" class="text-white-50">Home</a>
          <span class="text-white-50 mx-2"> > </span>
          <a href="../Presentation/mens.php" class="text-white"><u>Men's Eyewear</u></a>
        </h6>
      </nav>
      <!-- Breadcrumb -->
    </div>
      ...
      <div class="col-lg-9">
        ...
        <div class="row" id="result">
          ...
          <?php
            ...
            $sql = "SELECT * FROM product WHERE gender = 'male' LIMIT $items_per_page OFFSET $offset";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              // Pagination controls
              $result_total = $conn->query("SELECT COUNT(*) as total FROM product WHERE gender = 'male'");
