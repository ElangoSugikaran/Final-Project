    ...
    <div class="container py-4">
      ...
      <nav class="d-flex mb-2">
        <h6 class="mb-0">
          ...
          <a href="../Presentation/brand-reebok.php" class="text-white"><u>Prada EyeWear</u></a>
        </h6>
      </nav>
      <!-- Breadcrumb -->
    </div>
      ...
      <div class="col-lg-9">
        ...
        <div class="row" id="result">
          ...
          <?php
            ...
            $sql = "SELECT * FROM product WHERE brands = 'prada' LIMIT $items_per_page OFFSET $offset";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
              ...
              // Pagination controls
              $result_total = $conn->query("SELECT COUNT(*) as total FROM product WHERE brands = 'prada'");
